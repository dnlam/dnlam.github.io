...
<p align="justify">
My name is Ngoc-Lam DINH (Lam DINH). Currently, I am holding a research engineer position in network optimation at the <i> Huawei Paris Research Center (France)</i>. My main research focuses on improving data networks using (safe) Reinforcement Learning and mathematical optimization tools. <br> <br>
