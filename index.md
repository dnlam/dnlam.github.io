...
<p align="justify">
My name is Ngoc-Lam DINH (Lam DINH). Currently, I am a research engineer at the <i> Huawei Paris Research Center (France)</i>. My main research focuses on improving data networks using (safe) Reinforcement Learning. <br> <br>
...
Before that, I graduated from the <i> Ha Noi University of Science and Technology </i> (Vietnam) in 2016 with a degree in <b> Electronics and Telecommunications Engineering </b>. My training mainly focused on several areas: <b> (1) Digital signal processing, (2) Mobile and wireless communications and (3) Embedded systems</b>. Then, I took part in an <a href="http://www.upv.es/titulaciones/MUTSRC/indexi.html"> <i> international academic exchange program </i> </a> at the <i> Universidad Politecnica de Valencia (Spain) </i> in 2017, with the courses given in <b> Signal theory, Wireless transmissions and Optical networks. </b> <br>  <br>



My research interests are <b> Digital signal processing</b>, <b> Advanced communication protocols (wireless and data networks) based on (safe) Reinforcement Learning </b> and <b> Image processing with Deep Learning</b>. <br> <br>
