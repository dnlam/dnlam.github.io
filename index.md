...
<p align="justify">
Welcome to my personal website. Currently, I am holding a research engineer position in network optimazations at the <i> Huawei Paris Research Center (France)</i>. My main research focuses on safe data networks using <b>Learning-based models (DRL,LLMs, etc.)</b> and <b>Mathematical Optimization tools</b>. <br> <br>
